...
HD_PWD='/home/gabriel/PG/BubbleSorting/BubbleSorting.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sumatoria.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Sumatoria.tcl
