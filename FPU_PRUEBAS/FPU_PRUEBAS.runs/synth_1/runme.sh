...
HD_PWD='/home/gabriel/PG/FPU_PRUEBAS/FPU_PRUEBAS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPU_UART.vds -m64 -mode batch -messageDb vivado.pb -notrace -source FPU_UART.tcl
