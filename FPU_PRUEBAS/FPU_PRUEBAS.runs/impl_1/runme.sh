...
HD_PWD='/home/gabriel/PG/FPU_PRUEBAS/FPU_PRUEBAS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FPU_UART.vdi -applog -m64 -messageDb vivado.pb -mode batch -source FPU_UART.tcl -notrace
