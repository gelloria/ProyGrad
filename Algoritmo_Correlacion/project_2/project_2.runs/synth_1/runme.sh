...
HD_PWD='/home/gabriel/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Correlacion.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Correlacion.tcl
