...
HD_PWD='C:/Users/gmarin/Documents/PG/Detector/Detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SimCorrelacion.vds -m64 -mode batch -messageDb vivado.pb -notrace -source SimCorrelacion.tcl
