...
HD_PWD='/home/gabriel/PG/AlgoritmoCorrelacion/AlgoritmoCorrelacion.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AlgoritmoCorrelacion.vds -m64 -mode batch -messageDb vivado.pb -notrace -source AlgoritmoCorrelacion.tcl
