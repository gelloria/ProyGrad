...
HD_PWD='C:/Users/gmarin/Documents/PG/Pruebas_PG/Pruebas_PG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pattern_Counter.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Pattern_Counter.tcl
